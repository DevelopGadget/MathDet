...
public class Paso2_4x4 extends AppCompatActivity implements View.OnClickListener{
    ...
    TextView Cofactor1,Cofactor2,Cofactor3,Cofactor4;
    TextView X5_1,X6_1,X7_1,X8_1,X9_1,X10_1,X11_1,X12_1,X13_1;
    TextView X5_2,X6_2,X7_2,X8_2,X9_2,X10_2,X11_2,X12_2,X13_2;
    TextView X5_3,X6_3,X7_3,X8_3,X9_3,X10_3,X11_3,X12_3,X13_3;
    TextView X5_4,X6_4,X7_4,X8_4,X9_4,X10_4,X11_4,X12_4,X13_4;
    TextView Det1,Det2,Det3,Det4;
    Bundle A;
    ...
    private void Intancias(){
        Cofactor1 = (TextView) findViewById(R.id.Cofactor1);
        Cofactor2 = (TextView) findViewById(R.id.Cofactor2);
        Cofactor3 = (TextView) findViewById(R.id.Cofactor3);
        Cofactor4 = (TextView) findViewById(R.id.Cofactor4);
        X5_1 = (TextView) findViewById(R.id.X5_1);
        X5_2 = (TextView) findViewById(R.id.X5_2);
        X5_3 = (TextView) findViewById(R.id.X5_3);
        X5_4 = (TextView) findViewById(R.id.X5_4);
        X6_1 = (TextView) findViewById(R.id.X6_1);
        X6_2 = (TextView) findViewById(R.id.X6_2);
        X6_3 = (TextView) findViewById(R.id.X6_3);
        X6_4 = (TextView) findViewById(R.id.X6_4);
        X7_1 = (TextView) findViewById(R.id.X7_1);
        X7_2 = (TextView) findViewById(R.id.X7_2);
        X7_3 = (TextView) findViewById(R.id.X7_3);
        X7_4 = (TextView) findViewById(R.id.X7_4);
        X8_1 = (TextView) findViewById(R.id.X8_1);
        X8_2 = (TextView) findViewById(R.id.X8_2);
        X8_3 = (TextView) findViewById(R.id.X8_3);
        X8_4 = (TextView) findViewById(R.id.X8_4);
        X9_1 = (TextView) findViewById(R.id.X9_1);
        X9_2 = (TextView) findViewById(R.id.X9_2);
        X9_3 = (TextView) findViewById(R.id.X9_3);
        X9_4 = (TextView) findViewById(R.id.X9_4);
        X10_1 = (TextView) findViewById(R.id.X10_1);
        X10_2 = (TextView) findViewById(R.id.X10_2);
        X10_3 = (TextView) findViewById(R.id.X10_3);
        X10_4 = (TextView) findViewById(R.id.X10_4);
        X11_1 = (TextView) findViewById(R.id.X11_1);
        X11_2 = (TextView) findViewById(R.id.X11_2);
        X11_3 = (TextView) findViewById(R.id.X11_3);
        X11_4 = (TextView) findViewById(R.id.X11_4);
        X12_1 = (TextView) findViewById(R.id.X12_1);
        X12_2 = (TextView) findViewById(R.id.X12_2);
        X12_3 = (TextView) findViewById(R.id.X12_3);
        X12_4 = (TextView) findViewById(R.id.X12_4);
        X13_1 = (TextView) findViewById(R.id.X13_1);
        X13_2 = (TextView) findViewById(R.id.X13_2);
        X13_3 = (TextView) findViewById(R.id.X13_3);
        X13_4 = (TextView) findViewById(R.id.X13_4);
        Det1 = (TextView) findViewById(R.id.Det1);
        Det2 = (TextView) findViewById(R.id.Det2);
        Det3 = (TextView) findViewById(R.id.Det3);
        Det4 = (TextView) findViewById(R.id.Det4);
