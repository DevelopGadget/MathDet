...
public class cuatro extends AppCompatActivity implements View.OnClickListener{
    ...
    private void Resolver(){
        if(X14.getText().toString() == null || X14.getText().toString().equals("") || X15.getText().toString() == null || X15.getText().toString().equals("")
            ...
            x14 = Double.parseDouble(X14.getText().toString());   x15 = Double.parseDouble(X15.getText().toString());  x16 = Double.parseDouble(X16.getText().toString());   x17 = Double.parseDouble(X17.getText().toString());
            x18 = Double.parseDouble(X18.getText().toString());   x19 = Double.parseDouble(X19.getText().toString());  x20 = Double.parseDouble(X20.getText().toString());   x21 = Double.parseDouble(X21.getText().toString());
            x22 = Double.parseDouble(X22.getText().toString());   x23 = Double.parseDouble(X23.getText().toString());  x24 = Double.parseDouble(X24.getText().toString());   x25 = Double.parseDouble(X25.getText().toString());
            x26 = Double.parseDouble(X26.getText().toString());   x27 = Double.parseDouble(X27.getText().toString());  x28 = Double.parseDouble(X28.getText().toString());   x29 = Double.parseDouble(X29.getText().toString());
            ...
            builder.setMessage("El Determinante De La Matriz 4x4 Es: "+((Det1 + Det2 + Det3 + Det4)));
            builder.setPositiveButton("Explicación", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
                    Intent intent = new Intent(getApplicationContext(), Pasos4x4.class);
                    ...
                    intent.putExtra("x14",x14); intent.putExtra("x15",x15); intent.putExtra("x16",x16); intent.putExtra("x17",x17);
                    intent.putExtra("x21",x21); intent.putExtra("x20",x20); intent.putExtra("x19",x19); intent.putExtra("x18",x18);
                    intent.putExtra("x23",x23); intent.putExtra("x24",x24); intent.putExtra("x25",x25); intent.putExtra("x26",x26);
                    intent.putExtra("x22",x22); intent.putExtra("x29",x29); intent.putExtra("x28",x28); intent.putExtra("x27",x27);
